        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(shopname.getText().length()== 0){
                    ...
                    vendername.setError("Enter Client Name");
                }
                ...
                else
                {
                    counts= String.valueOf(count);
                     addClientModel= new AddClientModel(SharedPreferencesManager.getSomeStringValue(getApplication()),counts,shopname.getText().toString(),vendername.getText().toString(),contactno.getText().toString(),adress.getText().toString(),timeanddate);
                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplication())).child("Create-Client").child(counts+"-  "+shopname.getText().toString()).setValue(addClientModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
