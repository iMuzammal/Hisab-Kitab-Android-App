...
import com.example.AccountingAppAdmin.Adapter.SalerAdapter;
...
public class SalerAccount extends AppCompatActivity {


    ArrayList<PaymentMethodModel> arrayList = new ArrayList<>();
    SalerAdapter salerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saler_account);
        ...
        progressDialog = new ProgressDialog(SalerAccount.this, R.style.AppCompatAlertDialogStyle);
        ...
        databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplication())).child("Saler-PayHistory").child(venderName).child(method).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                progressDialog.dismiss();
                salerAdapter = new SalerAdapter(getApplication(), arrayList);
                recyclerView.setAdapter(salerAdapter);
