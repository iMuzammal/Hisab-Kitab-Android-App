        ...
        createpayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (method.getText().length() == 0) {
                    ...
                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplication())).child("PayHistory").child(selectVender).child(selectPayment).child(counts).setValue(paymentMethodModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
...
//
                                                    ...
                                                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplication())).child("BuyerBalance").child("Total-Balance").setValue(buyerBalance).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("BuyerBalance").child("Vender-Acount").child(selectVender).addListenerForSingleValueEvent(new ValueEventListener() {
                                                                @Override
                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                    if (dataSnapshot.getValue() != null) {
                                                                        ...
                                                                        if (venderBalance != null) {
                                                                            ...
                                                                            venderBalance = new VenderBalance(SharedPreferencesManager.getSomeStringValue(getApplication()), venderbalance);
                                                                                   databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("BuyerBalance").child("Vender-Acount").child(selectVender).setValue(venderBalance).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                @Override
                                                                                public void onSuccess(Void aVoid) {

//
                                                                                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("BuyerBalance").child("PaidAmount").child(selectVender).addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                        @Override
                                                                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                            if (dataSnapshot.getValue() != null) {
                                                                                                ...
                                                                                                if (paidAmountModel != null) {
                                                                                                    ...
                                                                                                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("BuyerBalance").child("PaidAmount").child(selectVender).setValue(paidAmountModel).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                        @Override
                                                                                                        public void onSuccess(Void aVoid) {

                                                                                                            Toast.makeText(Paymentmethod.this, "Done", Toast.LENGTH_SHORT).show();
                                                                                                        }
                                                                                                    });
                                                                                                ...
                                                                                                databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("BuyerBalance").child("PaidAmount").child(selectVender).setValue(paidAmountModel);
...
//                createVenderModel.getShopeName();
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Paymentmethod.this, "" + selectVender, Toast.LENGTH_SHORT).show();
            }
