...
public class SalerDashBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saler_dash_board);
        intent = getIntent();
        ...
        databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("Create-Client").child(venderName).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    if(createVenderModel!=null){
                        ...
                        databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("SalerBalance").child("Client-Acount").child(venderName).addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.getValue() != null) {
        ...
        databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("SalerBalance").child("PaidAmount").child(venderName).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.getValue()!=null){
                    ...
                    databaseReference.child(SharedPreferencesManager.getSomeStringValue(getApplicationContext())).child("SalerBalance").child(venderName).setValue(paidAmountModel);
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(getApplication(), SalerAccount.class);
        ...
        c2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = new Intent(getApplication(), SalerBankAccount.class);
                intent.putExtra("venderName", venderName);
                intent.putExtra("name", name);
